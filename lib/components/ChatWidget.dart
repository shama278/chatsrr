  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          Container(
            margin: isMe.validate() ? EdgeInsets.only(top: 3.0, bottom: 3.0, left: context.width() * 0.25, right: 8) : EdgeInsets.only(top: 4.0, bottom: 4.0, left: 8, right: context.width() * 0.25),
            ...
            child: Column(
              ...
              children: [
                Text(message!, style: primaryTextStyle(color: isMe ? Colors.white : textPrimaryColor, size: mChatFontSize), maxLines: null),
                Text(
