...
import '../../../utils/story/ImageLoader.dart';
            ...
            SafeArea(
              child: Align(
                ...
                child: Container(
                  ...
                  child: caption != null ? Text(caption, style: TextStyle(fontSize: 15, color: Colors.white), textAlign: TextAlign.center) : SizedBox(),
                ),
              ),
            )
          ],
                  ...
                  child: Row(
                    children: [
                      ...
                      Container(
                        ...
                        child: cachedImage(userImage, height: 40, fit: BoxFit.cover).cornerRadiusWithClipRRect(50),
                      ),
                      8.width,
                      Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text(username, style: primaryTextStyle(color: white)),
                          time,
                        ],
                      ).expand(),
                    ],
    ...
    return Container(
      ...
      child: Stack(
        children: <Widget>[
              ...
              child: GestureDetector(
                ...
                onVerticalDragUpdate: widget.onVerticalSwipeComplete == null
                    ...
                    : (details) {
                        ...
                        // todoo provide callback interface for animation purposes
                      },
          ...
          Positioned(
            right: isRTL ? 10 : context.width() - 50,
            child: Align(
              alignment: Alignment.centerRight,
              heightFactor: 1,
              child: Container(
